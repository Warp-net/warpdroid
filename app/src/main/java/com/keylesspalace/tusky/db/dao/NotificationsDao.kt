...
abstract class NotificationsDao {
    ...
    @Query(
        """
SELECT n.tuskyAccountId, n.type, n.id, n.loading, n.event, n.moderationWarning, n.emoji, n.emojiUrl,
...
s.pinned as 's_pinned', s.language as 's_language', s.filtered as 's_filtered', s.filterActive as 's_filterActive', s.quoteState as 's_quoteState', s.quotedStatusId as 's_quotedStatusId', s.quoteShown as 's_quoteShown',
...
q.contentCollapsed as 'q_contentCollapsed', q.pinned as 'q_pinned', q.language as 'q_language', q.filtered as 'q_filtered', q.filterActive as 'q_filterActive', q.quotedStatusId as 'q_quotedStatusId', q.quoteState as 'q_quoteState',
